...
SECRET_KEY = 'django-insecure-c-9om*zk^(fa4*rl3*8ceaq1^^8i4^@rn+_bxu*68%2n^(k+ey'
...
# CORS Settings
CORS_ALLOW_ALL_ORIGINS = True # Change to False in production and use CORS_ALLOWED_ORIGINS
